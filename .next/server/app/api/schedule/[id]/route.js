(()=>{var e={};e.id=569,e.ids=[569],e.modules={4729:e=>{"use strict";e.exports=require("bcryptjs")},846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},4870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},9294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},3033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3873:e=>{"use strict";e.exports=require("path")},325:(e,E,T)=>{"use strict";T.r(E),T.d(E,{patchFetch:()=>L,routeModule:()=>n,serverHooks:()=>I,workAsyncStorage:()=>R,workUnitAsyncStorage:()=>p});var t={};T.r(t),T.d(t,{GET:()=>d,PUT:()=>o});var r=T(2706),s=T(8203),a=T(5994),N=T(9187),i=T(6448);async function d(e,{params:E}){let{id:T}=await E,t=(0,i.L)(),r=t.prepare("SELECT * FROM schedules WHERE id = ?").get(T);if(!r)return N.NextResponse.json({error:"Not found"},{status:404});let s=t.prepare(`
  ...
  `).all(T);return N.NextResponse.json({...r,shifts:s})}async function o(e,{params:E}){let{id:T}=await E,{status:t}=await e.json(),r=(0,i.L)();return"approved"===t?r.prepare("UPDATE schedules SET status='approved', approved_at=CURRENT_TIMESTAMP WHERE id=?").run(T):"published"===t&&r.prepare("UPDATE schedules SET status='published', published_at=CURRENT_TIMESTAMP WHERE id=?").run(T),N.NextResponse.json({success:!0})}let n=new r.AppRouteRouteModule({definition:{kind:s.RouteKind.APP_ROUTE,page:"/api/schedule/[id]/route",pathname:"/api/schedule/[id]",filename:"route",bundlePath:"app/api/schedule/[id]/route"},resolvedPagePath:"/home/user/astro-sanity-starter/.claude/worktrees/agent-a398a3ecdd1c1a217/app/api/schedule/[id]/route.ts",nextConfigOutput:"",userland:t}),{workAsyncStorage:R,workUnitAsyncStorage:p,serverHooks:I}=n;function L(){return(0,a.patchFetch)({workAsyncStorage:R,workUnitAsyncStorage:p})}},6487:()=>{},8335:()=>{},6448:(e,E,T)=>{"use strict";let t;T.d(E,{L:()=>p});let r=require("better-sqlite3");var s=T.n(r),a=T(3873),N=T.n(a);let i=require("fs");var d=T.n(i),o=T(4729),n=T.n(o);let R=process.env.DB_PATH||N().join(process.cwd(),"data","store.db");function p(){if(!t){let e=N().dirname(R);d().existsSync(e)||d().mkdirSync(e,{recursive:!0}),(t=new(s())(R)).pragma("journal_mode = WAL"),t.pragma("foreign_keys = ON"),function(e){if(e.exec(`
