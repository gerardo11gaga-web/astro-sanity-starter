(()=>{var e={};e.id=93,e.ids=[93],e.modules={4729:e=>{"use strict";e.exports=require("bcryptjs")},846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},4870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},9294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},3033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3873:e=>{"use strict";e.exports=require("path")},8611:(e,E,T)=>{"use strict";T.r(E),T.d(E,{patchFetch:()=>I,routeModule:()=>d,serverHooks:()=>l,workAsyncStorage:()=>R,workUnitAsyncStorage:()=>p});var t={};T.r(t),T.d(t,{GET:()=>o,POST:()=>n});var r=T(2706),s=T(8203),a=T(5994),N=T(9187),i=T(6448);async function o(){let e=(0,i.L)().prepare(`
  ...
  `).all();return N.NextResponse.json(e)}async function n(e){let E=await e.json(),T=(0,i.L)().prepare(`
    INSERT INTO employees (first_name, last_name, phone, email, employee_type, max_hours_per_week, hire_date, notes)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?)
  `).run(E.first_name,E.last_name,E.phone||null,E.email||null,E.employee_type||"hourly",E.max_hours_per_week||40,E.hire_date||null,E.notes||null);return N.NextResponse.json({id:T.lastInsertRowid})}let d=new r.AppRouteRouteModule({definition:{kind:s.RouteKind.APP_ROUTE,page:"/api/employees/route",pathname:"/api/employees",filename:"route",bundlePath:"app/api/employees/route"},resolvedPagePath:"/home/user/astro-sanity-starter/.claude/worktrees/agent-a398a3ecdd1c1a217/app/api/employees/route.ts",nextConfigOutput:"",userland:t}),{workAsyncStorage:R,workUnitAsyncStorage:p,serverHooks:l}=d;function I(){return(0,a.patchFetch)({workAsyncStorage:R,workUnitAsyncStorage:p})}},6487:()=>{},8335:()=>{},6448:(e,E,T)=>{"use strict";let t;T.d(E,{L:()=>p});let r=require("better-sqlite3");var s=T.n(r),a=T(3873),N=T.n(a);let i=require("fs");var o=T.n(i),n=T(4729),d=T.n(n);let R=process.env.DB_PATH||N().join(process.cwd(),"data","store.db");function p(){if(!t){let e=N().dirname(R);o().existsSync(e)||o().mkdirSync(e,{recursive:!0}),(t=new(s())(R)).pragma("journal_mode = WAL"),t.pragma("foreign_keys = ON"),function(e){if(e.exec(`
