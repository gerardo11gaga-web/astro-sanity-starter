(()=>{var e={};e.id=677,e.ids=[677],e.modules={4729:e=>{"use strict";e.exports=require("bcryptjs")},846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},4870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},9294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},3033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3873:e=>{"use strict";e.exports=require("path")},6193:(e,E,T)=>{"use strict";T.r(E),T.d(E,{patchFetch:()=>L,routeModule:()=>n,serverHooks:()=>I,workAsyncStorage:()=>R,workUnitAsyncStorage:()=>p});var t={};T.r(t),T.d(t,{DELETE:()=>d,POST:()=>o});var r=T(2706),s=T(8203),a=T(5994),N=T(9187),i=T(6448);async function o(e,{params:E}){let{id:T}=await E,{department_id:t,pay_rate:r}=await e.json();return(0,i.L)().prepare("INSERT OR REPLACE INTO employee_departments (employee_id, department_id, pay_rate) VALUES (?, ?, ?)").run(T,t,r||0),N.NextResponse.json({success:!0})}async function d(e,{params:E}){let{id:T}=await E,{department_id:t}=await e.json();return(0,i.L)().prepare("DELETE FROM employee_departments WHERE employee_id = ? AND department_id = ?").run(T,t),N.NextResponse.json({success:!0})}let n=new r.AppRouteRouteModule({definition:{kind:s.RouteKind.APP_ROUTE,page:"/api/employees/[id]/departments/route",pathname:"/api/employees/[id]/departments",filename:"route",bundlePath:"app/api/employees/[id]/departments/route"},resolvedPagePath:"/home/user/astro-sanity-starter/.claude/worktrees/agent-a398a3ecdd1c1a217/app/api/employees/[id]/departments/route.ts",nextConfigOutput:"",userland:t}),{workAsyncStorage:R,workUnitAsyncStorage:p,serverHooks:I}=n;function L(){return(0,a.patchFetch)({workAsyncStorage:R,workUnitAsyncStorage:p})}},6487:()=>{},8335:()=>{},6448:(e,E,T)=>{"use strict";let t;T.d(E,{L:()=>p});let r=require("better-sqlite3");var s=T.n(r),a=T(3873),N=T.n(a);let i=require("fs");var o=T.n(i),d=T(4729),n=T.n(d);let R=process.env.DB_PATH||N().join(process.cwd(),"data","store.db");function p(){if(!t){let e=N().dirname(R);o().existsSync(e)||o().mkdirSync(e,{recursive:!0}),(t=new(s())(R)).pragma("journal_mode = WAL"),t.pragma("foreign_keys = ON"),function(e){if(e.exec(`
