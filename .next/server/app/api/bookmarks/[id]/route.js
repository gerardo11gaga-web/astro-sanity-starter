(()=>{var e={};e.id=573,e.ids=[573],e.modules={4729:e=>{"use strict";e.exports=require("bcryptjs")},846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},4870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},9294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},3033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3873:e=>{"use strict";e.exports=require("path")},5534:(e,E,T)=>{"use strict";T.r(E),T.d(E,{patchFetch:()=>L,routeModule:()=>d,serverHooks:()=>I,workAsyncStorage:()=>n,workUnitAsyncStorage:()=>R});var t={};T.r(t),T.d(t,{DELETE:()=>o});var r=T(2706),s=T(8203),a=T(5994),N=T(9187),i=T(6448);async function o(e,{params:E}){let{id:T}=await E;return(0,i.L)().prepare("DELETE FROM bookmarks WHERE id = ?").run(T),N.NextResponse.json({success:!0})}let d=new r.AppRouteRouteModule({definition:{kind:s.RouteKind.APP_ROUTE,page:"/api/bookmarks/[id]/route",pathname:"/api/bookmarks/[id]",filename:"route",bundlePath:"app/api/bookmarks/[id]/route"},resolvedPagePath:"/home/user/astro-sanity-starter/.claude/worktrees/agent-a398a3ecdd1c1a217/app/api/bookmarks/[id]/route.ts",nextConfigOutput:"",userland:t}),{workAsyncStorage:n,workUnitAsyncStorage:R,serverHooks:I}=d;function L(){return(0,a.patchFetch)({workAsyncStorage:n,workUnitAsyncStorage:R})}},6487:()=>{},8335:()=>{},6448:(e,E,T)=>{"use strict";let t;T.d(E,{L:()=>I});let r=require("better-sqlite3");var s=T.n(r),a=T(3873),N=T.n(a);let i=require("fs");var o=T.n(i),d=T(4729),n=T.n(d);let R=process.env.DB_PATH||N().join(process.cwd(),"data","store.db");function I(){if(!t){let e=N().dirname(R);o().existsSync(e)||o().mkdirSync(e,{recursive:!0}),(t=new(s())(R)).pragma("journal_mode = WAL"),t.pragma("foreign_keys = ON"),function(e){if(e.exec(`
