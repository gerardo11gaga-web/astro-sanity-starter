(()=>{var e={};e.id=967,e.ids=[967],e.modules={4729:e=>{"use strict";e.exports=require("bcryptjs")},846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},4870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},9294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},3033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3873:e=>{"use strict";e.exports=require("path")},7739:(e,E,T)=>{"use strict";T.r(E),T.d(E,{patchFetch:()=>L,routeModule:()=>d,serverHooks:()=>p,workAsyncStorage:()=>R,workUnitAsyncStorage:()=>I});var t={};T.r(t),T.d(t,{GET:()=>i,PUT:()=>n});var r=T(2706),s=T(8203),a=T(5994),N=T(9187),o=T(6448);async function i(){return N.NextResponse.json((0,o.L)().prepare("SELECT * FROM store_rules ORDER BY rule_key").all())}async function n(e){let E=await e.json(),T=(0,o.L)().prepare("UPDATE store_rules SET rule_value = ? WHERE rule_key = ?");for(let e of E)T.run(e.rule_value,e.rule_key);return N.NextResponse.json({success:!0})}let d=new r.AppRouteRouteModule({definition:{kind:s.RouteKind.APP_ROUTE,page:"/api/store-rules/route",pathname:"/api/store-rules",filename:"route",bundlePath:"app/api/store-rules/route"},resolvedPagePath:"/home/user/astro-sanity-starter/.claude/worktrees/agent-a398a3ecdd1c1a217/app/api/store-rules/route.ts",nextConfigOutput:"",userland:t}),{workAsyncStorage:R,workUnitAsyncStorage:I,serverHooks:p}=d;function L(){return(0,a.patchFetch)({workAsyncStorage:R,workUnitAsyncStorage:I})}},6487:()=>{},8335:()=>{},6448:(e,E,T)=>{"use strict";let t;T.d(E,{L:()=>I});let r=require("better-sqlite3");var s=T.n(r),a=T(3873),N=T.n(a);let o=require("fs");var i=T.n(o),n=T(4729),d=T.n(n);let R=process.env.DB_PATH||N().join(process.cwd(),"data","store.db");function I(){if(!t){let e=N().dirname(R);i().existsSync(e)||i().mkdirSync(e,{recursive:!0}),(t=new(s())(R)).pragma("journal_mode = WAL"),t.pragma("foreign_keys = ON"),function(e){if(e.exec(`
